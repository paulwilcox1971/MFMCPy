...
DEFAULT_PREFIX = {
    PROBE: PATH_SEPARATOR + 'PROBES' + PATH_SEPARATOR + 'P',
    LAW: PATH_SEPARATOR + 'LAWS' + PATH_SEPARATOR + 'L',
    SEQUENCE: PATH_SEPARATOR + 'SEQUENCES' + PATH_SEPARATOR + 'S',}

#Subset of sequence keys associated with frames - used in various places
FRAME_KEYS = [MFMC_DATA, 
              MFMC_DATA_IM, 
